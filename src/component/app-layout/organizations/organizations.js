        ...
        return(
            <div>
                <div className="col-md-8 p-0 float-left application-registration-detail-main-left">
                    <div className="col-md-12 p-0 float-left application-registration-detail Organizations-submit ">
                        <h2>Organizations activities</h2>
                        <div className="col-md-12   p-0 float-left">
                            <h6>Please describe all non school organizations you participated in during your high school years (grades 9-12 only).</h6>
                        </div>
                        <div className="col-md-12 p-0 float-left not-have">
                            <input type="checkbox" name="not_have" value="Not Have" /> I do not have any organizational activities during my high school years<br />
                        </div>
                        <div className="col-md-12 p-0 float-left form-application-registration-detail">
                                ...
                                <div key={index}>
                                    ...
                                    <div className="col-md-12 p-0 float-left organizations_clone organizations_clone_detail">
                                        ...
                                        <div id="clonedInput1" className="col-md-12 p-0 float-left  clone_guardian  clone_remove">
                                            ...
                                            <div className="col-md-12 p-0 float-left ">
                                                <p>Organization <span className="number_activity"></span></p>
                                                <input type="text" name="organization" onChange={this.handleChange.bind(this, "organization")} ref="organization1" value={array.organization} />
                                            </div>
                                            <div className="col-md-12 p-0 float-left">
                                                <div className="col-md-12 p-0 float-left ">
                                            ...
                                            <div className="col-md-12 p-0 float-left">
                                                <div className="col-md-6 p-0 float-left p_r_10">
                                                    ...
                                                    <select name="total_activity" value={array.total_activity} onChange={this.handleChange.bind(this, "total_activity")} ref="total_activity1">
                            ...
                            <form ref={(el) => this.myFormRef = el} className="">
                                        ...
                                        <div className="col-md-12 p-0 float-left organizations_clone">

                                            <div id="clonedInput1" className="col-md-12 p-0 float-left organizations_clone_detail clone_remove">
                                                <div className="col-md-12 p-0 float-left ">
                                                    <p>Organization <span className="number_activity"></span></p>
                                            <input type="text" name="organization" onChange={this.handleChange.bind(this, "organization")} ref="organization" />
												</div>
                                                    <div className="col-md-12 p-0 float-left">
                                                        <div className="col-md-12 p-0 float-left ">
                                                            <p>Organizations <span className="number_activity"></span> activities</p>
                                                <textarea rows="4" cols="80" name="community_service" onChange={this.handleChange.bind(this, "community_service")} ref="community_service"></textarea>
                                                    ...
                                                    <div className="col-md-12 p-0 float-left">
                                                        <div className="col-md-6 p-0 float-left p_r_10">
                                                            <p>Frequency of participation</p>
                                                <select name="frequency_of_participation" onChange={this.handleChange.bind(this, "frequency_of_participation")} ref="frequency_of_participation" id="frequency_of_participation">
                                                                <option value="Daily">Daily</option>
                                                                <option value="Weekly">Weekly</option>
                                                                <option value="Monthly">Monthly</option>
                                                                <option value="Annually">Annually</option>
                                                    ...
                                                    <div className="col-md-12 p-0 float-left">
                                                        <div className="col-md-6 p-0 float-left p_r_10">
                                                            <p>Total hours for this activity</p>
                                                <select name="total_activity" onChange={this.handleChange.bind(this, "total_activity")} ref="total_activity" id="total_activity">
                                                                <option value="1">1</option>
                                                                <option value="2">2</option>
                                                                <option value="3">3</option>
                                                                <option value="4">4</option>
                                ...
                                <div onClick={this.addOrganization} className="col-md-12   p-0 float-left clone_organizations_button">
                                                <h6><svg className="svg-inline--fa fa-plus-circle fa-w-16" aria-hidden="true" data-fa-processed="" data-prefix="fa" data-icon="plus-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm144 276c0 6.6-5.4 12-12 12h-92v92c0 6.6-5.4 12-12 12h-56c-6.6 0-12-5.4-12-12v-92h-92c-6.6 0-12-5.4-12-12v-56c0-6.6 5.4-12 12-12h92v-92c0-6.6 5.4-12 12-12h56c6.6 0 12 5.4 12 12v92h92c6.6 0 12 5.4 12 12v56z"></path></svg> <i className="fa fa-plus-circle" aria-hidden="true"></i> Add another organization</h6>
                                            </div>
                                            <div className="col-md-6  p-0  float-left button-submit">
                                                <input id="submit_form_application_1" type="button" name="submit_form_organizations" value="Save and continue"/>
										</div> 
									</form>
