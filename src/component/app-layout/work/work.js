        ...
        return(
            <div>
                <div class="col-md-8 p-0 float-left application-registration-detail-main-left">
                    <div class="col-md-12 p-0 float-left application-registration-detail Work-submit ">
                            ...
                            <form action="" class="form-application-registration-detail">
                                ...
                                <div class="col-md-12 p-0 float-left not-have">
                                    <input type="checkbox" name="not_have" value="Not Have"/> I do not have any work experiences during my high school years<br/>
                                        ...
                                        <div class="col-md-12 p-0 float-left work_clone">

                                            <div id="clonedInput1" class="col-md-12 p-0 float-left work_clone_detail clone_detail clone_remove">
                                                <h6 class="remove float-right">remove</h6>
                                                <div class="col-md-12 p-0 float-left ">
                                                    <div class="col-md-6 p-0 float-left p_r_10 ">
                                                        <p>Work position / title <span class="number_activity"></span></p>
                                                        <input type="text" name="position[]"/>
															</div>
                                                        <div class="col-md-12 p-0 float-left">
                                                            <div class="col-md-12 p-0 float-left ">
                                                                <p>Work reponsibilities <span class="number_activity"></span></p>
