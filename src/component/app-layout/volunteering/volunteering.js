        ...
        return (
            <div>
                <div class="col-md-8 p-0 float-left application-registration-detail-main-left">
                    <div class="col-md-12 p-0 float-left application-registration-detail Volunteering-submit ">
                            ...
                            <form action="" class="form-application-registration-detail">
                                ...
                                <div class="col-md-12 p-0 float-left not-have">
                                    <input type="checkbox" name="not_have" value="Not Have"/> I do not have any volunteer activities during my high school years<br/>
                                        ...
                                        <div class="col-md-12 p-0 float-left volunteering_clone">
                                            <div id="clonedInput1" class="col-md-12 p-0 float-left volunteering_clone_detail clone_remove">
                                                <h6 class="remove float-right">remove</h6>
                                                <div class="col-md-12 p-0 float-left">
                                                    <div class="col-md-12 p-0 float-left p_r_10">
                                                        <p>Community service <span class="number_activity"></span></p>
